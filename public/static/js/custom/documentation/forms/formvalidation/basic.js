...
var KTFormValidationDemoBasic = {
    init: function() {
        ! function() {
            ...
            var e = FormValidation.formValidation(t, { fields: { text_input: { validators: { notEmpty: { message: "Text input is required" } } } }, plugins: { trigger: new FormValidation.plugins.Trigger, bootstrap: new FormValidation.plugins.Bootstrap5({ rowSelector: ".fv-row", eleInvalidClass: "", eleValidClass: "" }) } });
        ...
        function() {
            ...
            var e = FormValidation.formValidation(t, { fields: { input_group_input: { validators: { notEmpty: { message: "Input is required" } } } }, plugins: { trigger: new FormValidation.plugins.Trigger, bootstrap: new FormValidation.plugins.Bootstrap5({ rowSelector: ".fv-row", eleInvalidClass: "", eleValidClass: "" }) } });
